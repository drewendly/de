...
(function ($, window, document) {
	...
	******************************************************************************/
	var defaults = {
		...
		button_SIZE: 35,							//Button width and height (in pixels)
		...
		button_BG_COLOR: '',					//Button set's background color in hexadecimal
		button_BG_TRANSPARENCY: 100,					//Background transparency (in percentage)
		...
		button_ALIGN: 'top right',				//Button set can be aligned to any side or center
		button_MARGIN: 20,							//Space between button set and view port's edge
